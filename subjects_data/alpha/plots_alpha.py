...
# Inicializar las listas de edades
real_ages = []
predicted_ages = []

file_path = '/home/usuaris/imatge/joan.manel.cardenas/age_predictions/alpha_res/res_alpha_female_DA_2_bias_corr.txt'
...
plt.savefig('res_alpha_male_final_bias_corr.png')
